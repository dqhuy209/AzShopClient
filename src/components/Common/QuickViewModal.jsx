        ...
        {loading ? (
          ...
          <div className="flex gap-12.5 h-full">
              ...
              <div className="flex h-full gap-5 w-full">
                <div className="relative flex flex-col h-full gap-5 overflow-hidden">
                  ...
                  <Swiper
                     ...
                     */
                    slidesPerView={Math.min(mediaItems.length || 0, 6)}
                    loop={false}
            ...
            <div className="flex-1 max-w-[445px] w-full space-y-5 overflow-y-auto h-full">
              ...
              {/* Product Title */}
              <Link
                href={`/shop-details/${displayProduct?.id}`}
                className="text-2xl font-bold leading-tight transition-colors duration-200 text-dark hover:text-blue"
                onClick={() => handleCloseModal()}
              >
