              ...
              <div className="max-w-[526px] w-full">
                <div className="flex gap-5">
                  <div className="flex flex-col gap-5">
                    {displayProduct?.images?.map((img, key) => (
                      <button
              ...
              <div className="max-w-[445px] w-full">
                {displayProduct?.discountPercent > 0 && (
                  <span className="inline-block text-custom-xs font-medium text-white py-1 px-3 bg-blue mb-6.5">
                    SALE {displayProduct.discountPercent}% OFF
                  </span>
                )}
                ...
                <div className="flex flex-wrap items-center gap-5 mb-6">
                  ...
                  {displayProduct?.categoryName && (
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-dark-2">Dòng:</span>
                      <span className="font-medium text-dark">
                        {displayProduct.categoryName}
                      </span>
                    </div>
                    ...
                    <div className="space-y-2">
                      {displayProduct.attributes.map((attr) => (
                        <div key={attr.id} className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-dark">{attr.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
