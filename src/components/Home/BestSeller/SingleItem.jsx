  ...
  return (
    <div className="h-full overflow-hidden transition-all duration-300 ease-out bg-white rounded-xl group shadow-1 hover:shadow-2">
      ...
      <div className="relative overflow-hidden flex items-center justify-center rounded-t-xl bg-gray h-[300px] p-4">
        ...
        <div className="absolute flex flex-col gap-2 duration-300 ease-linear translate-x-full opacity-0 right-4 top-4 group-hover:translate-x-0 group-hover:opacity-100">
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 text-white duration-200 ease-out rounded-full shadow-lg bg-green hover:bg-green-dark hover:scale-110"
          >
            <svg
              className="fill-current"
              width="16"
      ...
      <div className="flex flex-col h-auto p-6 space-y-4">
        {/* Title với chiều cao cố định và font size lớn hơn */}
        <div className="min-h-[3rem] flex items-start">
          <h3 className="text-lg font-semibold leading-tight transition-colors duration-300 cursor-pointer decoration-transparent text-dark-3 hover:text-red line-clamp-2">
        ...
        {/* Price Section - luôn ở cuối với font size lớn hơn */}
        <div className="pt-3 mt-auto border-t border-gray-3">
