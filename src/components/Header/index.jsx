...
const Header = () => {
    ...
    return (
        ...
        >
            <div
                className="absolute z-[10] bg-[#ec6804] bg-[url(/images/logo/bg-header.jpg)] w-full h-full top-0 left-0"></div>
            <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0 relative z-[20]">
                <div
                    className={`flex flex-row gap-5 items-center xl:justify-between ease-out duration-200 ${stickyMenu ? 'py-4' : 'py-6'}`}
                >
                    <Link
                        className="flex-shrink-0 flex gap-x-[10px] items-center"
                        href="/"
                    >
                        <div className={'size-[40px] lg:size-[80px]'}>
                            <Image
                                src="/images/logo/logo.png"
                                alt="Logo"
                                width={80}
                                height={80}
                                className=" border border-white rounded-full p-[16px]"
                            />
                        </div>
                        <Image
                ...
                <span className="block relative cursor-pointer w-5.5 h-5.5">
                  <span className="du-block absolute right-0 w-full h-full">
                    ...
                    ></span>
                    <span
                        className={`block relative top-0 left-0 bg-[#fff] rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-150 ${!navigationOpen && '!w-full delay-400'}`}
                    ></span>
                    <span
                  ...
                  <span className="block absolute right-0 w-full h-full rotate-45">
                    ...
                    ></span>
                    <span
                        className={`block bg-[#fff] rounded-sm ease-in-out duration-200 delay-400 absolute left-0 top-2.5 w-full h-0.5 ${!navigationOpen && '!h-0 dealy-200'}`}
                    ></span>
                  </span>
                </span>
                            </button>
